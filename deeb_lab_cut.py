...
experimenter = 'Flo'
list_of_videos = ['C:/Users/flori/OneDrive/Documents/University of Amsterdam/Internship/DeepLabCutData/Video_02_06_24.mp4']
...
deeplabcut.extract_frames(config=config_file_path,mode='automatic',algo='kmeans',userfeedback=False, crop=True)
